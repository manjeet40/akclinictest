...
export default function CaseStudyIndex({
  ...
  const pageTitle = `Hair Transplant Case Studies by AK Clinics${
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="We share here the case studys relate to the different problems of the patients. "
        />
        <link
          rel="canonical"
          href="https://akclinic-new.vercel.app/blog/case-study/"
        />
          ...
          <div className="container">
            <div className="training_content blog__category__success__stories">
              <div className="training_banner_content">
                ...
                >
                  Articles related to Case Study
                </h1>
                <h2 className="banner_training_sub_txt">
                  latest information and news about Case Study.
                </h2>
              </div>
              <div className="bread_crums training_bread_crums">
                <p className="bread_crum_content">
                  ...
                  {">"} <span className="color_bread_crums">Case Study</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container second__blog__section">
        ...
        <AuthorPostsPagination totalPages={totalPages} currentPage={1} />
      </div>
...
export async function getServerSideProps({ params }) {
  ...
  const apiUrl = `https://admin.akclinics.com/wp-json/wp/v2/posts?per_page=600&categories=178`;
