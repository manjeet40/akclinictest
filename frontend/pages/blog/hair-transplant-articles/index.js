...
import AuthorPostsPagination from "@/components/paginations/CaseStudy";
import HairTransplantPagination from "@/components/paginations/HairTransplantArticles";
...
export default function HairTransplantIndex({
  posts,
  currentPage,
  totalPages,
  commonData,
  ...
  const pageTitle = `Know All About Hair Transplant Article and Information${
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Know all about the Hair Transplant Surgery their latest techniques and technologies and the types of Hair Transplant"
        />
        <link
          rel="canonical"
          href="https://akclinic-new.vercel.app/blog/hair-transplant-articles/"
        />
          ...
          <div className="container">
            <div className="training_content blog__category__success__stories">
              <div className="training_banner_content">
                ...
                >
                  Articles related to Hair Transplant Articles
                </h1>
                <h2 className="banner_training_sub_txt">
                  latest information and news about Hair Transplant Articles.
                </h2>
              </div>
              <div className="bread_crums training_bread_crums">
                <p className="bread_crum_content">
                  ...
                  {">"}{" "}
                  <span className="color_bread_crums">
      ...
      <div className="container second__blog__section">
        ...
        <HairTransplantPagination totalPages={totalPages} currentPage={1} />
      </div>
...
export async function getServerSideProps({ params }) {
  ...
  const apiUrl = `https://admin.akclinics.com/wp-json/wp/v2/posts?per_page=600&categories=19`;
