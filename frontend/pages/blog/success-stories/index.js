...
import SuccessStoriesPagination from "@/components/paginations/SuccessStories";
...
export default function SuccessStoriesIndex({
  ...
  const pageTitle = `Hair Transplant Success Stories by AK Clinics${
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Here we share the case and surgery detail of the patient who get their sucessfull surgery done by AK Clinics"
        />
        <link
          rel="canonical"
          href="https://akclinic-new.vercel.app/blog/success-stories/"
        />
          ...
          <div className="container">
            <div className="training_content blog__category__success__stories">
              <div className="training_banner_content">
                ...
                >
                  Articles related to Success Stories
                </h1>
                <h2 className="banner_training_sub_txt">
                  latest information and news about success stories.
                </h2>
              </div>
              <div className="bread_crums training_bread_crums">
                <p className="bread_crum_content">
                  ...
                  {">"}{" "}
                  <span className="color_bread_crums">Success Stories</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container second__blog__section">
        ...
        <SuccessStoriesPagination totalPages={totalPages} currentPage={1} />
      </div>
...
export async function getServerSideProps({ params }) {
  ...
  const apiUrl = `https://admin.akclinics.com/wp-json/wp/v2/posts?per_page=600&categories=201`;
