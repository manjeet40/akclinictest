...
import CosmetologyPagination from "@/components/paginations/cosmetology";
...
export default function CosmetologyIndex({
  posts,
  currentPage,
  totalPages,
  commonData,
  ...
  const pageTitle = `Cosmetology and Dermatology Skin Care Treatments${
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Read all about the cosmetology or the skin care, anti-aging and the other skin related problem and theri treatment."
        />
        <link
          rel="canonical"
          href="https://akclinic-new.vercel.app/blog/cosmetology/"
        />
          ...
          <div className="container">
            <div className="training_content blog__category__success__stories">
              <div className="training_banner_content">
                ...
                >
                  Articles related to Cosmetology
                </h1>
                <h2 className="banner_training_sub_txt">
                  latest information and news about Cosmetology.
                </h2>
              </div>
              <div className="bread_crums training_bread_crums">
                <p className="bread_crum_content">
                  ...
                  {">"} <span className="color_bread_crums">Cosmetology</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container second__blog__section">
        ...
        <CosmetologyPagination totalPages={totalPages} currentPage={1} />
      </div>
...
export async function getServerSideProps({ params }) {
  ...
  const apiUrl = `https://admin.akclinics.com/wp-json/wp/v2/posts?per_page=600&categories=49`;
