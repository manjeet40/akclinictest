...
import CosmeticSurgeryPagination from "@/components/paginations/CosmeticSurgery";
...
export default function CosmeticSurgeryIndex({
  posts,
  currentPage,
  totalPages,
  commonData,
  ...
  const pageTitle = `All About Plastic and Cosmetic Surgery${
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Read here about the costmetic surgeries like Rhinoplasty, Blepharoplasty, Gynecomastia, Liposuction, Breast augmentation and Gynecology treatments which provided by AK Clinics."
        />
        <link
          rel="canonical"
          href="https://akclinic-new.vercel.app/blog/cosmetic-surgery-articles/"
        />
          ...
          <div className="container">
            <div className="training_content blog__category__success__stories">
              <div className="training_banner_content">
                ...
                >
                  Articles related to Cosmetic Surgery Articles
                </h1>
                <h2 className="banner_training_sub_txt">
                  latest information and news about Cosmetic Surgery Articles.
                </h2>
              </div>
      ...
      <div className="container second__blog__section">
        ...
        <CosmeticSurgeryPagination totalPages={totalPages} currentPage={1} />
      </div>
...
export async function getServerSideProps({ params }) {
  ...
  const apiUrl = `https://admin.akclinics.com/wp-json/wp/v2/posts?per_page=600&categories=389`;
