...
import StyleshalaPagination from "@/components/paginations/Styleshala";
...
export default function StyleshalaIndex({
  posts,
  currentPage,
  totalPages,
  commonData,
  ...
  const pageTitle = `Hair Styles with their Guide${
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A K Clinics has started styleshala with a motive to sharing various hair styles with their guide for all kind of hairs."
        />
        <link
          rel="canonical"
          href="https://akclinic-new.vercel.app/blog/styleshala/"
        />
          ...
          <div className="container">
            <div className="training_content blog__category__success__stories">
              <div className="training_banner_content">
                ...
                >
                  Articles related to StyleShala
                </h1>
                <h2 className="banner_training_sub_txt">
                  latest information and news about StyleShala.
                </h2>
              </div>
              <div className="bread_crums training_bread_crums">
                <p className="bread_crum_content">
                  ...
                  {">"} <span className="color_bread_crums">StyleShala</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container second__blog__section">
        ...
        <StyleshalaPagination totalPages={totalPages} currentPage={1} />
      </div>
...
export async function getServerSideProps({ params }) {
  ...
  const apiUrl = `https://admin.akclinics.com/wp-json/wp/v2/posts?per_page=600&categories=427`;
