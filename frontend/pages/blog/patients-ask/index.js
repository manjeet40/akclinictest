...
import PatientAskPagination from "@/components/paginations/PatientAsk";
...
export default function CaseStudyIndex({
  ...
  const pageTitle = `Question Ask By Patients about Hair Transplant &amp; Cosmetology- AK Clinics${
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Patient ask their queries and questions on hair transplant and cosmetology from the experts and answer given by the doctors of AK Clinics"
        />
        <link
          rel="canonical"
          href="https://akclinic-new.vercel.app/blog/patient-ask/"
        />
          ...
          <div className="container">
            <div className="training_content blog__category__success__stories">
              <div className="training_banner_content">
                ...
                >
                  Articles related to Patients Ask?
                </h1>
                <h2 className="banner_training_sub_txt">
                  latest information and news about Patients Ask?.
                </h2>
              </div>
              <div className="bread_crums training_bread_crums">
                <p className="bread_crum_content">
                  ...
                  {">"} <span className="color_bread_crums">Patients Ask?</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container second__blog__section">
        ...
        <PatientAskPagination totalPages={totalPages} currentPage={1} />
      </div>
...
export async function getServerSideProps({ params }) {
  ...
  const apiUrl = `https://admin.akclinics.com/wp-json/wp/v2/posts?per_page=600&categories=175`;
