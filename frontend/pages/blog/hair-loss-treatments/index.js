...
import HairLossTreatmentPagination from "@/components/paginations/HairLossTreatment";
...
export default function HairLossTreatmentsArticlesIndex({
  posts,
  currentPage,
  totalPages,
  commonData,
  ...
  const pageTitle = `Article on Hair Loss and Hair Fall Treatments${
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Read all about the baldness or hair loss and their medical, surgical and non surgical treatments."
        />
        <link
          rel="canonical"
          href="https://akclinic-new.vercel.app/blog/hair-loss-treatments/"
        />
          ...
          <div className="container">
            <div className="training_content blog__category__success__stories">
              <div className="training_banner_content">
                ...
                >
                  Articles related to Hair Loss Treatment Articles
                </h1>
                <h2 className="banner_training_sub_txt">
                  latest information and news about Hair Loss Treatment
                  Articles.
                </h2>
              </div>
      ...
      <div className="container second__blog__section">
        ...
        <HairLossTreatmentPagination totalPages={totalPages} currentPage={1} />
      </div>
...
export async function getServerSideProps({ params }) {
  ...
  const apiUrl = `https://admin.akclinics.com/wp-json/wp/v2/posts?per_page=600&categories=33`;
