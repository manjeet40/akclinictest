...
import MedicalTreatmentPagination from "@/components/paginations/MedicalTreatments";
...
export default function MedicalTreatmentsArticlesIndex({
  posts,
  currentPage,
  totalPages,
  commonData,
  ...
  const pageTitle = `Medical Treatment for Hair Loss and related problems${
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Baldness, Hair fall and related problems can be treated by medications and the therapys, Read all about the medically treatment of hair loss."
        />
        <link
          rel="canonical"
          href="https://akclinic-new.vercel.app/blog/medical-treatment-articles/"
        />
          ...
          <div className="container">
            <div className="training_content blog__category__success__stories">
              <div className="training_banner_content">
                ...
                >
                  Articles related to Hair Medical Treatment Articles
                </h1>
                <h2 className="banner_training_sub_txt">
                  latest information and news about Medical Treatment Articles.
                </h2>
              </div>
      ...
      <div className="container second__blog__section">
        ...
        <MedicalTreatmentPagination totalPages={totalPages} currentPage={1} />
      </div>
...
export async function getServerSideProps({ params }) {
  ...
  const apiUrl = `https://admin.akclinics.com/wp-json/wp/v2/posts?per_page=600&categories=202`;
