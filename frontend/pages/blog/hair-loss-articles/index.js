...
import HairLossArticlesPagination from "@/components/paginations/HairLoss";
...
export default function HairLossArticlesIndex({
  posts,
  currentPage,
  totalPages,
  commonData,
  ...
  const pageTitle = `Hair Loss, Baldness and Hair Fall Problem Article${
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Read all about the hair loss or the baldness related problem like hair fall and hair thinning also their causes and the treatments."
        />
        <link
          rel="canonical"
          href="https://akclinic-new.vercel.app/blog/hair-loss-articles/"
        />
          ...
          <div className="container">
            <div className="training_content blog__category__success__stories">
              <div className="training_banner_content">
                ...
                >
                  Articles related to Hair Loss Articles
                </h1>
                <h2 className="banner_training_sub_txt">
                  latest information and news about Hair Loss Articles.
                </h2>
              </div>
              <div className="bread_crums training_bread_crums">
                <p className="bread_crum_content">
                  ...
                  {">"}{" "}
                  <span className="color_bread_crums">Hair Loss Articles</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container second__blog__section">
        ...
        <HairLossArticlesPagination totalPages={totalPages} currentPage={1} />
      </div>
...
export async function getServerSideProps({ params }) {
  ...
  const apiUrl = `https://admin.akclinics.com/wp-json/wp/v2/posts?per_page=600&categories=25`;
